...
```
##### Other information
This project has been really troublesome when my computer crashed and panicked and had to fix it in the best way. It took a lot of my time and energy. I tore off my hamstrings and have been to the hospital a number of times, which has also taken my time and energy.
```
# Technologies Used
